...
def get_initkw():
    ...
    initkw = {
        'channels': 'rgb',
        'classes': {'graph': [('fish', {'id': 1, 'name': 'fish'}, [])], 'id_to_node': {1: 'fish'}, 'idx_groups': [[0]], 'idx_to_node': ['fish'], 'node_to_id': {'fish': 1}, 'node_to_idx': {'fish': 0}},
        'input_stats': {'rgb': {'mean': [[[0.09]], [[0.09]], [[0.09]]], 'std': [[[0.112]], [[0.112]], [[0.112]]]}},
    }
    return initkw


def get_model_cls():
    model_cls = MM_CascadeRCNN
    return model_cls
